...
require(['jquery', 'Vue', 'bootstrap', 'common', 'index', 'header', 'dashboard', 'list', 'profile', 'publish', 'register', 'setting', 'help', 'project-list', 'top-up', 'account', 'connection'], function($, Vue) {
